...
@Component({
  selector: 'app-view-van-details',
  templateUrl: './view-van-details.component.html',
  styleUrls: ['./view-van-details.component.css']
})
export class ViewVanDetailsComponent implements OnInit {
