...
@Component({
  selector: 'app-view-van-student-details',
  templateUrl: './view-van-student-details.component.html',
  styleUrls: ['./view-van-student-details.component.css']
})
export class ViewVanStudentDetailsComponent implements OnInit {
