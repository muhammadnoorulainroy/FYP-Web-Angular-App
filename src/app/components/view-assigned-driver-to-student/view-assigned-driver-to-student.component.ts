...
@Component({
  selector: 'app-view-assigned-driver-to-student',
  templateUrl: './view-assigned-driver-to-student.component.html',
  styleUrls: ['./view-assigned-driver-to-student.component.css']
})
export class ViewAssignedDriverToStudentComponent implements OnInit {
